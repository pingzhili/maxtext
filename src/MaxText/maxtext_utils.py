...
def maybe_dump_jaxpr(config, p_train_step, state, shaped_batch, init_rng):
  ...
  p_train_jaxpr = jax.make_jaxpr(p_train_step)(state, shaped_batch, init_rng)
  ...
  if config.dump_jaxpr_gcs_dir:
    gcs_utils.upload_dump(
        ...
        delete_local_after=True,  # Keeping local for debugging
